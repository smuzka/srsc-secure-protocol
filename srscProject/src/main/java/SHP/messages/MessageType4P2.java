...
public class MessageType4P2 extends Message {
    private byte[] nonce4;
    private byte[] nonce5;
    ...
    private byte[] ydhServer;

    public MessageType4P2(String password, String userId, byte[] nonce4_previous) {
        this.password = password;
        this.userId = userId;
        this.nonce4_previous = nonce4_previous;
    }

    public MessageType4P2(byte[] nonce4, byte[] nonce5, String userId, String requestConfirmation,
            String cryptoConfig, byte[] ydhServer) {
        this.nonce4 = nonce4;
        this.nonce5 = nonce5;
        this.userId = userId;
    ...
    private void decryptAndDeserializeData(byte[] data) {
        ...
        Serializer<byte[]> ydhServerSerializer = Serializer
                .deserializeFirstBytesInArray(cryptoConfigDeserialized.getRemainingBytes());
        this.ydhServer = ydhServerSerializer.getExtractedBytes();
    }
    ...
    public String toString() {
        return "MessageType4: " + "request-confirmation=" + requestConfirmation + ", userId=" + userId + ", nonce4="
                ...
                + ", ydhServer=" + Arrays.toString(ydhServer);
    }
}
